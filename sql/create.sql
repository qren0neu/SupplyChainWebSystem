...
CREATE TABLE `route_node` (
  `pkRouteNode` varchar(45) NOT NULL,
  `fkRoute` int NOT NULL,
  `fkNode` varchar(45) NOT NULL,
...
-- Dump completed on 2022-12-17  9:23:27
-- MySQL dump 10.13  Distrib 8.0.28, for macos11 (x86_64)
--
...
CREATE TABLE `orders` (
  ...
  `fkorderout` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`pkorder`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-17  9:23:28
-- MySQL dump 10.13  Distrib 8.0.28, for macos11 (x86_64)
--
...
CREATE TABLE `item_price` (
  ...
  `fkitem` int NOT NULL,
  `price` float NOT NULL,
  `dayneed` int NOT NULL DEFAULT '3',
  `fkcompany` int NOT NULL,
  PRIMARY KEY (`pkitemprice`),
  KEY `fk_item_id_ip_idx` (`fkitem`),
  CONSTRAINT `fk_item_id_ip` FOREIGN KEY (`fkitem`) REFERENCES `item` (`pkitem`)
...
--
-- Table structure for table `manu_cost`
--

DROP TABLE IF EXISTS `manu_cost`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `manu_cost` (
  `pkmanucost` int NOT NULL AUTO_INCREMENT,
  `fkproduct` int NOT NULL,
  `fkraw` int NOT NULL,
  `amount` int NOT NULL,
  PRIMARY KEY (`pkmanucost`),
  KEY `fk_cost_item_id_idx` (`fkproduct`),
  CONSTRAINT `fk_cost_item_id` FOREIGN KEY (`fkproduct`) REFERENCES `item` (`pkitem`) ON DELETE CASCADE ON UPDATE CASCADE
...
--
-- Table structure for table `node_risk`
--

DROP TABLE IF EXISTS `node_risk`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `node_risk` (
  `pkNodeRisk` varchar(45) NOT NULL,
  `fkNode` varchar(45) NOT NULL,
  `fkRisk` varchar(45) NOT NULL,
  PRIMARY KEY (`pkNodeRisk`),
  KEY `fk_node_risk_node_id_idx` (`fkNode`),
  KEY `fk_node_risk_risk_id_idx` (`fkRisk`),
  CONSTRAINT `fk_node_risk_node_id` FOREIGN KEY (`fkNode`) REFERENCES `Node` (`pkNode`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_node_risk_risk_id` FOREIGN KEY (`fkRisk`) REFERENCES `risk` (`pkrisk`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `route` (
  `pkRoute` varchar(45) NOT NULL,
  `estTime` int NOT NULL,
  `fkService` varchar(45) NOT NULL,
  PRIMARY KEY (`pkRoute`),
  KEY `fk_route_service_id_idx` (`fkService`),
  CONSTRAINT `fk_route_service_id` FOREIGN KEY (`fkService`) REFERENCES `service` (`pkService`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `route_company`
--

DROP TABLE IF EXISTS `route_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `route_company` (
  `pkroutecompany` varchar(45) NOT NULL,
  `fkroute` varchar(45) NOT NULL,
  `fkcompany` int NOT NULL,
  PRIMARY KEY (`pkroutecompany`),
  UNIQUE KEY `unique_route_company` (`fkroute`,`fkcompany`) USING BTREE,
  KEY `fk_rc_routeid_idx` (`fkroute`),
  CONSTRAINT `fk_rc_routeid` FOREIGN KEY (`fkroute`) REFERENCES `route` (`pkRoute`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `service` (
  `pkService` varchar(45) NOT NULL,
  `costPer` int NOT NULL,
  `factor` float NOT NULL,
  `fkCompany` int NOT NULL DEFAULT '-1',
  PRIMARY KEY (`pkService`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trans_service` (
  `pkTransService` varchar(45) NOT NULL,
  `fkService` varchar(45) NOT NULL,
  `fkTrans` varchar(45) NOT NULL,
  PRIMARY KEY (`pkTransService`),
  KEY `fk_trans_id_idx` (`fkTrans`),
  KEY `fk_service_id_idx` (`fkService`),
  CONSTRAINT `fk_service_id` FOREIGN KEY (`fkService`) REFERENCES `service` (`pkService`) ON DELETE RESTRICT ON UPDATE CASCADE,
